// ContextMenu — Radix wrapper for right-click affordances (tab rename /
// mark-unread / close and friends). Shares the exact Medusa recipe with
// DropdownMenu via ./menuSurface, so a right-click menu and a click-dropdown are
// visually indistinguishable. (It used to be raw shadcn "new-york" — 14px rows
// with a blue accent-wash on hover — which read as a different component.)
