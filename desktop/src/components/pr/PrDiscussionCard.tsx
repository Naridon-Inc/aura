  ...
  return (
    <section className="border border-line-soft rounded-lg bg-bg-content overflow-hidden">
      <button
        ...
        className="w-full flex items-center gap-2 px-4 h-11 hover:bg-bg-2/50 transition-colors"
      >
        <svg
          width="11"
          height="11"
      ...
      {!collapsed && (
        <div className="px-4 pb-4 pt-1">
          {count === 0 ? (
            <div className="text-text-4 text-[12px] py-2">
...
function DiscussionRow({ c }: { c: PrComment }) {
  ...
  return (
    <li className="flex gap-2.5">
      <span className="w-6 h-6 rounded-full bg-violet/30 text-violet flex items-center justify-center text-[10.5px] font-bold flex-shrink-0">
        {initial}
      </span>
      <div className="flex-1 min-w-0">
        ...
        <div className="mt-1 text-[12.5px] text-text-2 leading-[1.55] [&_p]:my-0 [&_p+p]:mt-2">
