...
The full manual: the desktop app, every capability, the complete command
reference and the Claude Code status line. The [README](../README.md) is the
short version; this is everything.
